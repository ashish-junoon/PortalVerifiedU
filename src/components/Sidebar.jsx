...
const Sidebar = () => {
    ...
    const isActive = (path) =>
        location.pathname === path ? "text-white font-semibold bg-primary my-1" : "text-gray-600";
    ...
    return (
        <div className="w-64 top-16 bg-[#0b1120] border-r border-t border-gray-200 fixed shadow-sm z-50 max-md:w-full overflow-y-auto" style={{height: 'calc(100dvh - 4rem)'}}>
            {/* LOGO */}
            ...
            <ul className="mt-5 space-y-0 px-2">
                        ...
                        <ul className="ml-8 mt-1 space-y-1">
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    {openSubmenu === "pan" ? <FiChevronDown className="text-white" /> : <FiChevronRight className="text-white" />}
                                </div>
                ...
                <li>
                    ...
                    >
                        ...
                        {openMenu === "gst" ? <FiChevronDown className="text-white" /> : <FiChevronRight className="text-white" />}
                    </div>
                ...
                <li>
                    ...
                    >
                        ...
                        {openMenu === "bank" ? <FiChevronDown className="text-white" /> : <FiChevronRight className="text-white" />}
                    </div>
                ...
                <li>
                    ...
                    >
                        ...
                        {openMenu === "enach" ? <FiChevronDown className="text-white" /> : <FiChevronRight className="text-white" />}
                    </div>
                ...
                <li>
                    ...
                    >
                        ...
                        {openMenu === "pg" ? <FiChevronDown className="text-white" /> : <FiChevronRight className="text-white" />}
                    </div>
