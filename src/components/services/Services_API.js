...
export const GetExprianReport = async (req) => {
  try {
    const response = await api.post(
      "Experian/GetIndivisualCreditReportPdf",
      req,
    );
    return response.data;
  } catch (error) {
...
export const GetCrifReport = async (req) => {
  try {
    const response = await api.post(
      "/Crif/Credit-Report/credit-report-crif-pdf-v1",
      req,
    );
    return response.data;
  } catch (error) {
...
export const GetCrifReportUid = async (req) => {
  try {
    const response = await api.post(
      "/Crif/Credit-Report/credit-report-crif-pdf",
      req,
    );
    return response.data;
  } catch (error) {
...
export const GetTransUnionReport = async (req) => {
  try {
    const response = await api.post(
      "TransUnion/GetIndivisualCreditReport",
      req,
    );
    return response.data;
  } catch (error) {
...
export const GetTransactionById = async (req) => {
  try {
    // const data=serviceAmountDeduct();

    const response = await api.post("/verifiedu/GetTransactionById", req);
    return response.data;
  } catch (error) {
    console.error("Login error:", error.response?.data || error.message);
    throw error;
...
export const GetPaymentDetailsById = async (req) => {
  try {
    const response = await api.post(
      "/api/EasebuzzIntegration/GetPaymentDetaisByID",
      req,
    );
    return response.data;
  } catch (error) {
...
export const PullPaymentUsingEMandate = async (req) => {
  try {
    ...
    console.error(
      "PullPaymentUsingEMandate error:",
      error.response?.data || error.message,
    );
    throw error;
  }
...
export const UploadVendorDocument = async (req) => {
  try {
    const response = await api.post("/Admin/UploadVendorDocument", req, {
...
//To Fetch Vendors Documents
export const FetchVendorDocuments = async (req) => {
  try {
    const response = await api.post(req.url, req);
    return response.data;
  } catch (error) {
