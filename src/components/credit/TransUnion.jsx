...
function TransUnion() {
    ...
    const handleDownload = () => {
        if (res?.Data?.cibilURL) {
            const link = document.createElement("a");
            link.href = res.Data.cibilURL;
                ...
                FulfillOfferRequest: {
                    CustomerInfo: {
                        ...
                        IdentificationNumber: {
                            ...
                            Id: values.panNumber.toUpperCase()
                        },
                        Address: {
    ...
    const borrowerName = res?.Data?.response?.GetCustomerAssetsResponse?.GetCustomerAssetsSuccess?.Asset?.TrueLinkCreditReport?.Borrower?.BorrowerName?.Name.Forename;

    const riskScore = res?.Data?.response?.GetCustomerAssetsResponse?.GetCustomerAssetsSuccess?.Asset?.TrueLinkCreditReport?.Borrower?.CreditScore?.riskScore;

    const identifiers = res?.Data?.response?.GetCustomerAssetsResponse?.GetCustomerAssetsSuccess?.Asset?.TrueLinkCreditReport?.Borrower?.IdentifierPartition?.Identifier[1].ID.Id;
        ...
        <div>
            ...
            <div className="flex">
                ...
                <div className={`${isOpenSidebar && "lg:ml-64"} md:p-6 p-2 flex-1`}>
                    {!isReport && res?.Data?.response?.GetCustomerAssetsResponse == null && (
