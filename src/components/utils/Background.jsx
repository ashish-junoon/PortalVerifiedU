...
//   "
            <div
                className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-blue-400/30 to-primary/20 rounded-full blur-3xl animate-pulse"
                style={{ animation: "float 6s ease-in-out infinite, pulse 4s ease-in-out infinite" }}
            />
            <div
                className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-primary/30 to-primarydark/20 rounded-full blur-3xl"
