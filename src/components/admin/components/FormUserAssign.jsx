...
const FormUserAssign = ({
  ...
  useEffect(() => {
    ...
    report.setValues({
      ...
      user: selectedVendor || editService.vendor_code,
  ...
  return (
    <div className="p-0 mt-0 max-w-6xl mx-auto bg-white rounded-lg">
        ...
        {/* <div>
          ...
          <select
            ...
            className={`w-full border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-blue-500 ${
              report.touched.user && report.errors.user ? "border-red-500" : ""
            }`}
          >
