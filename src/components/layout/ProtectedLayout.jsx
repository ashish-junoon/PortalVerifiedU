          ...
          <div className="flex h-16 items-center justify-between">
              ...
              <Link onClick={closeOnMobile} to="/">
                <div className="flex items-center space-x-2">
                  ...
                  {/* <div className="text-black text-2xl italic font-semibold tracking-tight ">
                                        Verified<span className="text-primary font-bold">U</span>
                                    </div> */}
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* <button
                ...
                className="rounded-full cursor-pointer p-1 text-gray-400 hover:text-gray-600  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
              >
              ...
              <Menu as="div" className="relative">
                {/* <MenuButton className="flex rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary cursor-pointer border border-gray-300 shadow-lg">
                ...
                <MenuButton className="flex items-center gap-3 cursor-pointer px-3 py-1 rounded-full">
                  <span className="sr-only">Open user menu</span>
                  ...
                  <div className="text-left hidden sm:block">
                    ...
                    <p className="text-xs text-gray-500">
                      {vendorDetails?.vendoremail || "N/A"}
                    </p>
                  </div>
                </MenuButton>
                <MenuItems className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white  py-1 shadow-lg border border-primary/30 focus:outline-none">
                  <MenuItem>
                    <Link
                      to="/profile"
